...
class PeopleRecyclerViewAdapter(private val ListOfPeople: List<PersonData>) :
    ...
    override fun onBindViewHolder(holder: PeopleViewHolder, position: Int) {
        ...
        val individualPosition: PersonData = ListOfPeople[position]
        ...
        holder.personImage.setOnClickListener { v ->
            val intent = Intent(holder.personImage.context, SecondActivity::class.java)
